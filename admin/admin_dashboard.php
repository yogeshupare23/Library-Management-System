		...
		<div class="row">
			<div class="col-md-3 mt-3">
				<div class="card bg-light">
					...
					<div class="card-body">
						<p class="card-text">No. of total users:
							<?php echo get_user_count(); ?>
						</p>
						<a href="regusers.php" class="btn btn-info" target="_blank">View Registered Users</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 mt-3">
				<div class="card bg-light">
					...
					<div class="card-body">
						<p class="card-text">No. of availbale books:
			...
			<div class="col-md-3 mt-3">
				<div class="card bg-light">
					...
					<div class="card-body">
						<p class="card-text">No. of book's category:
			...
			<div class="col-md-3 mt-3">
				<div class="card bg-light">
					<div class="card-header"><strong>Registered Authors</strong></div>
					<div class="card-body">
						<p class="card-text">No. of availbale authors:
			...
			<div class="col-md-3 mt-3">
				<div class="card bg-light">
					...
					<div class="card-body">
						<p class="card-text">No. Issued Books:
							<?php echo get_issued_book_count(); ?>
						</p>
